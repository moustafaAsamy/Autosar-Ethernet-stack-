...
//
//*****************************************************************************
#define MEMP_NUM_PBUF                     16    // Default 16, was 16 // not used as we donot use pbuf_ROM
//#define MEMP_NUM_RAW_PCB                4
#define MEMP_NUM_UDP_PCB                  4     // NO_OF TCB control block
#define MEMP_NUM_TCP_PCB                  4     // NO_OF TCB control block
#define MEMP_NUM_TCP_PCB_LISTEN           0     // is replaced by  TCB control block
...
#define PBUF_POOL_SIZE                    8    // Default 16, NO of the pbufs handed to the stack from the hardware , the received
                                               // frame can be stored in 2 due to the length of the of each one
                                               // ex: you
...
#define PBUF_POOL_BUFSIZE               1000         // default is LWIP_MEM_ALIGN_SIZE(TCP_MSS+40+PBUF_LINK_HLEN)
